...
public class InfoStatusServiceTest {
    ...
    @Before
    public void setUp(){
        this.infoStatusService = new InfoStatusServiceImpl(hiRezSmiteApi, authenticationService); //inject the mock
    }
    ...
    public void testSession_Fail() {
        ...
        String testSession = infoStatusService.testSession();
    ...
    public void testDataUsage_Success() {
        when(hiRezSmiteApi.dataUsage(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any()))
                .thenReturn(UtilsTest.createdDataUsageSuccess());
        when(authenticationService.createSession()).thenReturn(UtilsTest.createdSessionSuccess());

        List<DataUsage> listDataUsage = infoStatusService.dataUsage();
    ...
    public void testDataUsage_Fail() {
        when(hiRezSmiteApi.dataUsage(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any()))
                .thenReturn(UtilsTest.createdDataUsageFail());
        when(authenticationService.createSession()).thenReturn(UtilsTest.createdSessionSuccess());

        List<DataUsage> dataUsage = infoStatusService.dataUsage();
    ...
    public void testHiRezSeverStatus_Success() {
        when(hiRezSmiteApi.hiRezServerStatus(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any()))
                .thenReturn(UtilsTest.createdServerStautsSuccess());
        when(authenticationService.createSession()).thenReturn(UtilsTest.createdSessionSuccess());

        List<HiRezServerStatus> listHiRezServerStatus = infoStatusService.hiRezServerStatus();
    ...
    public void testHiRezSeverStatus_Fail() {
        when(hiRezSmiteApi.hiRezServerStatus(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any()))
                .thenReturn(UtilsTest.createdServerStautsFail());
        when(authenticationService.createSession()).thenReturn(UtilsTest.createdSessionSuccess());
    ...
    public void testSmitePatchVersion_Success() {
        when(hiRezSmiteApi.smitePatchVersion(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any()))
                .thenReturn(UtilsTest.createdSmitePatchVersionSuccess());
        when(authenticationService.createSession()).thenReturn(UtilsTest.createdSessionSuccess());

        SmitePatchVersion smitePatchVersion = infoStatusService.smitePatchVersion();
    ...
    public void testSmitePatchVersion_Fail() {
        when(hiRezSmiteApi.smitePatchVersion(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any()))
                .thenReturn(UtilsTest.createdSmitePatchVersionFail());
        when(authenticationService.createSession()).thenReturn(UtilsTest.createdSessionSuccess());
